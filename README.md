About google-auth-feedstock
===========================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/google-auth-feedstock/blob/main/LICENSE.txt)

Home: https://github.com/googleapis/google-cloud-python/tree/main/packages/google-auth

Package license: Apache-2.0

Summary: Google authentication library for Python

Development: https://github.com/googleapis/google-cloud-python/tree/main/packages/google-auth
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/google-auth-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/google-auth-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add google-auth
# for installing globally
pixi global install google-auth
```
...
It is possible to list all of the versions of `google-auth` available on your platform:
...
```
pixi search google-auth --channel conda-forge
```
